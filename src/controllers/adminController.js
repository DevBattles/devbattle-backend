...
export const adminController = {
  ...
  async approveTeacherAccount(req, res, next) {
    try {
      ...
      const teacher = await adminService.approveTeacherAccount(id, validated.isApproved);
  ...
  async createCollege(req, res, next) {
    try {
      ...
      const college = await adminService.createCollege(validated.name);
  ...
  async createDepartment(req, res, next) {
    try {
      ...
      const department = await adminService.createDepartment(validated.collegeId, validated.name);
